...
function Input(props: IInput) {
    const { placeholder, usesOn, value, isUpper, maxLength, onChangeText } = props;
    if (usesOn == "selectNameOfPlayers") {
        ...
        return (
            <div className="flex w-full items-center justify-center gap-x-3">
                ...
                <input
                    className="w-full h-11 rounded-2xl bg-[#1E293B] text-white px-4 outline-none font-light text-xl placeholder:text-[#64748B]"
                    placeholder={placeholder}
                    value={value}
